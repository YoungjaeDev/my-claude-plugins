...
bridge_source: council/commands/council
---
...
```bash
[ -f ./AGENTS.md ] && echo "AGENTS.md: ✅" || echo "AGENTS.md: ❌ (Claude context limited)"
...
- ./AGENTS.md (Claude Opus/Sonnet)
- ./AGENTS.md (Codex)
- ./gemini.md (Gemini)
- ~/.codex/AGENTS.md (All models - user-global style/response guidelines)
- .codex/rules/*.md (All models - module-specific rules, if directory exists)
```
...
Task(model="opus", subagent_type="general-purpose", run_in_background: true):
  prompt: |
    ...
    ## Guidelines
    Read and follow ~/.codex/AGENTS.md (user-global) plus ./AGENTS.md project guidelines.
...
Task(model="sonnet", subagent_type="general-purpose", run_in_background: true):
  prompt: [Same structure as Opus, including:
    Read and follow ~/.codex/AGENTS.md (user-global) plus ./AGENTS.md for style guidelines.]
```
...
Task(subagent_type="general-purpose", run_in_background: true):
  prompt: |
    ...
    ## Guidelines
    Read and follow ~/.codex/AGENTS.md (user-global) plus ./gemini.md project guidelines.
    You have access to MCP tools. Use them actively to gather accurate information.
...
- Respect `@AGENTS.md` project conventions
