...
bridge_source: notion/notion-md-uploader
---
...
```bash
uv run python .codex/skills/notion-md-uploader/scripts/upload_md.py \
    docs/report.md \
...
```bash
uv run python .codex/skills/notion-md-uploader/scripts/upload_md.py --help
```
