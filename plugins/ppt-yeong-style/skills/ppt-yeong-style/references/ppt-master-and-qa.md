...
- **레이아웃 분포**: 빌드된 덱 기준으로 layout 유형 카운트를 재집계 — 동일 layout 3장 연속 없음, 텍스트형(two-col·checklist·table·timeline-table) 합 ≤50% (§2 셀프 체크와 동일 기준. md 단계를 통과했어도 빌드 중 장 추가·삭제·통합으로 다시 쏠릴 수 있다).
