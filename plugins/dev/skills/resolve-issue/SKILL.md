...
10.5. **[NEW] Auto cr-fix loop (default ON)**:
    ...
    - For a PR into a branch CodeRabbit does not auto-review, cr-fix posts `@coderabbitai review` itself, unless the repo set `reviews.auto_review.enabled: false` (`plugins/dev/skills/cr-fix/SKILL.md` Step 2).
    - On non-success exit:
