"""Shared REST helpers for the wiki plugin's mem0 scripts. stdlib only.

All mem0 scripts in the wiki plugin talk to the mem0 Platform REST API directly
...
def api_key() -> str:
    ...
    if not k:
        sys.exit("MEM0_API_KEY not set. the wiki plugin's mem0 skills require a mem0 Platform API key.")
    return k
