...
bridge_source: council/council-setup
---
...
Create `GEMINI.md` in your project root (similar to AGENTS.md):
...
[ -f ./AGENTS.md ] && echo "  AGENTS.md: ✅" || echo "  AGENTS.md: ❌ (create for Claude)"
