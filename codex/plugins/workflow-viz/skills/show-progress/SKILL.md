---
name: show-progress
description: "Display current workflow progress as ASCII visualization. Trigger: \"show progress\", \"workflow status\", \"진행 상황\""
version: 1.0.0
allowed-tools:
  - Read
  - Bash
bridge_source: workflow-viz/show-progress
---
...
Read current progress from `.codex/state/workflow-progress.json`.
...
- `.codex/state/github-dev-*.json` (excluding archive/)
