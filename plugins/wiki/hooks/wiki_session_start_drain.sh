...
# session to process them through the wiki:ingest-finding dedup gate, then
...
#
# Shell portability (see plugins/wiki/CLAUDE.md): BSD/GNU stat fallback, cksum
