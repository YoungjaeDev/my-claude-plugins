...
md 확정 시 **layout 태그 분포 표를 사용자 검토에 제출** — 동일 layout 3장 연속 or 텍스트형(two-col/checklist/table) 합 >50%면 재분산(단일 유형 % 임계 하나로는 못 잡음 — 분포 표를 사람 눈에 통과시키는 것까지가 게이트).
