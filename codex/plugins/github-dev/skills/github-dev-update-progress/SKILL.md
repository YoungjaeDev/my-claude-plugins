---
name: github-dev-update-progress
description: "Sync project progress to GitHub milestones/issues"
bridge_source: github-dev/commands/update-progress
---

# Update Progress

Manually sync project progress to GitHub milestones and issues. Regenerates architecture diagrams and updates tracking sections. Follow project guidelines in `@AGENTS.md`.

## Arguments

- Milestone name (optional): Target milestone to update. If omitted, auto-detect from `.codex/state/project-tracking-*.json`
...
1. **Load State File**
   - If milestone name provided: slugify and load `.codex/state/project-tracking-{slug}.json`
   - If `--all`: scan all `.codex/state/project-tracking-*.json` files
...
7. **Save State File**
   ...
   - Save to `.codex/state/project-tracking-{slug}.json`
