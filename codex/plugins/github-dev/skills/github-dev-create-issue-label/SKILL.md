---
name: github-dev-create-issue-label
description: "Create Issue Labels"
bridge_source: github-dev/commands/create-issue-label
---

## Create Issue Labels

Analyze project structure and create appropriate GitHub issue labels. Follow project guidelines in `@AGENTS.md`.
