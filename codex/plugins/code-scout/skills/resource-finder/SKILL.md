...
description: "Shared search hygiene + cwd-free GitHub / Hugging Face query reference for code-scout's github-scout and hf-scout agents. Date anchoring, multi-query patterns, quality filters, and the optional Python wrappers for richer JSON output. Use when authoring a query that runs through `gh` or HF REST and you want the canonical cheat-sheet."
bridge_source: code-scout/resource-finder
---
