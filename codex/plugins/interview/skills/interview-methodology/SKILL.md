...
version: 0.2.0
bridge_source: interview/interview-methodology
---
...
3. Write the comprehensive spec to `.codex/spec/{YYYY-MM-DD}-{feature-name}.md`
   - Date: Interview completion date (ISO format)
   - Feature name: kebab-case (e.g., `dark-mode`, `user-authentication`)
   - Create `.codex/spec/` directory if it doesn't exist
4. The spec should be detailed enough for implementation without further questions

## Spec Output Format

**File path**: `.codex/spec/{YYYY-MM-DD}-{feature-name}.md`

**Examples**:
- `.codex/spec/2026-01-20-dark-mode.md`
- `.codex/spec/2026-01-20-api-rate-limiting.md`
