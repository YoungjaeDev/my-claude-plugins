...
allowed-tools:
  ...
  - AskUserQuestion
  - Task
bridge_source: tcrei-prompt/tcrei-prompt
---
...
6. **Save to file** - store the final prompt at `.codex/prompts/{YYYY-MM-DD}-{name}.md`
...
2. Save to `.codex/prompts/{YYYY-MM-DD}-{name}.md`
   - Create `.codex/prompts/` directory if it does not exist
...
Saved to: `.codex/prompts/2026-02-16-blog-post.md`
```
