"""Hermes Agent adapter for the docs-forge plugin.
...
registers the existing SKILL.md files under the ``docs-forge:<skill>`` namespace.
"""
...
def register(ctx) -> None:
    """Register docs-forge skills with Hermes.

    Hermes automatically qualifies these as ``docs-forge:<name>`` based on the
