"""Hermes Agent adapter for the ppt-yeong-style plugin.
...
registers the existing SKILL.md files under the ``ppt-yeong-style:<skill>`` namespace.
"""
...
def register(ctx) -> None:
    """Register ppt-yeong-style skills with Hermes.

    Hermes automatically qualifies these as ``ppt-yeong-style:<name>`` based on the
