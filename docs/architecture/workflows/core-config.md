...
flowchart TB
    ...
    class PT,ST,NT eventStyle
    class AF,NO hookStyle
```
...
User-global work guidelines live in `~/.claude/CLAUDE.md` (auto-loaded by Claude Code as a system reminder). No injection hook is required.
