---
name: setup
description: Use when user encounters "paper-search MCP error", "Docker not found", "Docker not running", "paper search not working", "Semantic Scholar rate limit", or needs help installing, configuring, or verifying the Paper Search MCP integration.
---
