...
- diagnose one existing skill and get a graded fix list — that is `docs-forge:skill-audit`
- sweep every skill in the repository — that is `docs-forge:skill-fleet-review`
