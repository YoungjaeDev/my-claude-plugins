...
# drain hook surfaces for wiki:ingest-finding curation. Capture (mechanical,
...
#
# Shell portability (see plugins/wiki/CLAUDE.md): LC_ALL=C.UTF-8 around grep -E,
...

{
  ...
  printf '## How to curate (next session, via wiki:ingest-finding)\n'
