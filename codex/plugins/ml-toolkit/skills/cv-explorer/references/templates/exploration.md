...
Uses the appropriate loader from `data-loaders.md`.
...
# {data_loader_code}  -- Insert from data-loaders.md based on data_format
...
# {annotation_renderer_code}  -- From patterns.md Pattern G (supervision or cv2 branch)
...
Insert Pattern C from patterns.md.

```python
# ============================================================
# Section: Side-by-Side Comparison
# ============================================================
# See patterns.md Pattern C for full implementation
```
...
Insert Pattern D from patterns.md.

```python
# ============================================================
# Section: Threshold Tuning
# ============================================================
# See patterns.md Pattern D for full implementation
```
...
# --- Compute Stats ---
stats = compute_statistics(annotations)  # From patterns.md Pattern E
