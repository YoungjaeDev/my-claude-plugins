"""Hermes Agent adapter for the anti-slop-design plugin.
...
registers the existing SKILL.md files under the ``anti-slop-design:<skill>`` namespace.
"""
...
def register(ctx) -> None:
    """Register anti-slop-design skills with Hermes.

    Hermes automatically qualifies these as ``anti-slop-design:<name>`` based on the
