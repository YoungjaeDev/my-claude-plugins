"""Hermes Agent adapter for the code-scout plugin.
...
registers the existing SKILL.md files under the ``code-scout:<skill>`` namespace.
"""
...
def register(ctx) -> None:
    """Register code-scout skills with Hermes.

    Hermes automatically qualifies these as ``code-scout:<name>`` based on the
