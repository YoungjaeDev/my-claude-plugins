---
name: council-ask-gemini
description: "Request Gemini review with Claude cross-check"
bridge_source: council/commands/ask-gemini
---
...
- On timeout: reduce AGENTS.md to key sections, use `tree -L 1`
...
### Work Guidelines
Read and follow ~/.codex/AGENTS.md (user-global) plus any project AGENTS.md / gemini.md.
If .codex/rules/ exists, also read relevant rule files for module-specific guidance.
